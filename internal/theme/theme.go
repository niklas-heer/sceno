...
// Canvas composition. Header heights include breathing room between chrome and content.
const (
	CanvasTextInset        = 32.0
	CanvasPaddingExtra     = 20.0
	HeaderTitleBaseline    = 36.0
	HeaderSubtitleBaseline = 64.0
	HeaderTitleOnlyHeight  = 84.0
	HeaderFullHeight       = 108.0
)
