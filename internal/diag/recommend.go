...
func categoryForCode(code Code) string {
	switch code {
	case CodeEdgeCollision, CodeEdgeHidden, CodeArrowDetached, CodeArrowHidden, CodeArrowCluster, CodeEdgeLabelChrome, CodeEdgeLabelOverlap, CodeEdgeLabelOffAxis, CodeEdgeSideMismatch, CodeEdgeDetour:
		return "edges"
...
func priorityForCode(code Code) int {
	...
	case CodeEdgeCollision, CodeArrowDetached:
		return 1
	case CodeEdgeHidden, CodeArrowCluster, CodeEdgeLabelChrome, CodeEdgeLabelOverlap, CodeEdgeLabelOffAxis, CodeEdgeDetour, CodeMisaligned, CodeOccluded, CodeDenseLayout, CodeSlideCrowded, CodeAnnotationBlocks:
		return 2
